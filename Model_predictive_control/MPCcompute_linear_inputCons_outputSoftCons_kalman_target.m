function u_new=MPCcompute_linear_inputCons_outputSoftCons_kalman_target(R,Y,D,U,Us,Ad,Bd,Bd_d,Css,u_min,u_max,u_delta_min,u_delta_max,z_min,z_max,N,Q_cof,u_delta_cof,eta_cof,Wu_cof)
%%%%需要模型信息，A,B,C,D...
num_x=4;
num_u=2;
num_d=2;
...
%与输入参考值误差
Hu_ref=diag([Wu_cof*ones(N*num_u,1);zeros(N*num_eta,1)]);
