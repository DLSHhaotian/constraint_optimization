function u_new=MPCcompute_linear_inputCons_outputSoftCons_qp_numerical_kalman(R,Y,D,U,Ad,Bd,Bd_d,Css,u_min,u_max,u_delta_min,u_delta_max,z_min,z_max,N,Q_cof,u_delta_cof,eta_cof)
%%%%需要模型信息，A,B,C,D...
num_x=4;
num_u=2;
num_d=2;
