function [x,x_bar,d_bar,y]=model_sim_sto_linear_kalman(u,d,w,v,t,N,x0,xbar0,dbar0,nxbar,A,B,C,D,L_kf,AL,BL,BdL,G_w,CL,DL,p)
% --------------------------------------------------------------
...
u_kf=u(:,k);
X_bar=A*x_kf+B*u_kf+L_kf*(y(:,k)-(C*x_kf+D*u_kf));
